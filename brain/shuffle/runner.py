...
os.makedirs(setup.FIGURES_FOLDER_NICHEVI, exist_ok=True)
...
for setting in niche_setup.keys():
    ...
    if setup_dict["type_to_shuffle"] is not None:
        ...
        print(
            ...
            setup.NICHE + "_" + setup_dict["type_to_shuffle"].split()[0],
        )

        adata.obs[setup.NICHE + "_" + setup_dict["type_to_shuffle"].split()[0]] = (
            region_array
        )
...
plot_history(figure_folder=setup.FIGURES_FOLDER)
